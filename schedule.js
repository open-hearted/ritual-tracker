...
window.RITUAL_SCHEDULE = {
  ...
  appointments: [
    ...
    { date: "2026-08-06", time: "19:45", label: "ACG2 4-8", short: "ACG2 4-8", icon: "", calendarTime: false },
    { date: "2026-08-27", time: "19:45", label: "ACG2 4-9", short: "ACG2 4-9", icon: "", calendarTime: false },
    { date: "2026-09-10", time: "19:45", label: "ACG2 4-10", short: "ACG2 4-10", icon: "", calendarTime: false },
    { date: "2026-09-24", time: "19:45", label: "ACG2 5-01", short: "ACG2 5-01", icon: "", calendarTime: false },
    { date: "2026-10-01", time: "19:45", label: "ACG2 5-02", short: "ACG2 5-02", icon: "", calendarTime: false },
    { date: "2026-10-22", time: "19:45", label: "ACG2 5-03", short: "ACG2 5-03", icon: "", calendarTime: false },
    { date: "2026-11-12", time: "19:45", label: "ACG2 5-04", short: "ACG2 5-04", icon: "", calendarTime: false },
    { date: "2026-11-26", time: "19:45", label: "ACG2 5-05", short: "ACG2 5-05", icon: "", calendarTime: false },
    { date: "2026-12-10", time: "19:45", label: "ACG2 5-06", short: "ACG2 5-06", icon: "", calendarTime: false },
    { date: "2026-12-24", time: "19:45", label: "ACG2 5-07", short: "ACG2 5-07", icon: "", calendarTime: false },
    { date: "2027-01-14", time: "19:45", label: "ACG2 5-08", short: "ACG2 5-08", icon: "", calendarTime: false },
    { date: "2027-01-28", time: "19:45", label: "ACG2 5-09", short: "ACG2 5-09", icon: "", calendarTime: false },
    { date: "2027-02-04", time: "19:45", label: "ACG2 5-10", short: "ACG2 5-10", icon: "", calendarTime: false },
  ...
  shifts: [
    { weekdays: [0, 2, 3, 6], start: "13:00", end: "22:00", label: "シフトイン", calendarColor: "rgba(110,168,255,0.20)", exceptDates: ["2026-07-04"] }
  ],
  garbage: [
    {
      type: "nthWeekday",
